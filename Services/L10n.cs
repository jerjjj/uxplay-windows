...
public static class L10n
{
    ...
    static readonly Dictionary<string, string> _en = new()
    {
        ...
        ["desc.overscan"] = "Set display to overscanned mode (not yet supported in this build) (-o)",
        ...
        ["desc.restrict"] = "Only allow connections from specified devices (not yet supported) (-restrict)",
        ...
        ["desc.show_fps"] = "Show video streaming performance reports in logs (not yet supported) (-FPSdata)",
        ["desc.new_window"] = "Close video window when client stops mirroring (not yet supported) (-nc)",
    ...
    static readonly Dictionary<string, string> _zh = new()
    {
        ...
        ["desc.overscan"] = "设置显示过扫描模式（此版本暂未实现）（-o）",
        ...
        ["desc.restrict"] = "仅允许指定设备连接（此版本暂未实现）（-restrict）",
        ...
        ["desc.show_fps"] = "在日志中显示视频流性能报告（此版本暂未实现）（-FPSdata）",
        ["desc.new_window"] = "客户端停止镜像时关闭视频窗口（此版本暂未实现）（-nc）",
