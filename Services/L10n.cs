...
public static class L10n
{
    ...
    static readonly Dictionary<string, string> _en = new()
    {
        ...
        ["desc.overscan"] = "Set display to overscanned mode (-o)",
        ...
        ["desc.restrict"] = "Only allow connections from specified devices (-restrict)",
        ...
        ["desc.new_window"] = "Close video window when client stops mirroring (-nc) (overrides Keep Window)",
    ...
    static readonly Dictionary<string, string> _zh = new()
    {
        ...
        ["desc.restrict"] = "仅允许指定设备连接（-restrict）",
        ...
        ["desc.show_fps"] = "在日志中显示视频流性能报告（-FPSdata）",
        ["desc.new_window"] = "客户端停止镜像时关闭视频窗口（-nc）（覆盖保留视频窗口）",
